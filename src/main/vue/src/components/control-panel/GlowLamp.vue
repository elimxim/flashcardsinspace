...
.light-base {
  ...
  background: radial-gradient(
    ...
    color-mix(in srgb, var(--lamp--color) calc(v-bind(intensityNum) * 65%), transparent)
      calc(v-bind(radiusPct) * 0.6),
    color-mix(in srgb, var(--lamp--color) calc(v-bind(intensityNum) * 35%), transparent)
      v-bind(radiusPct),
    color-mix(in srgb, var(--lamp--color) calc(v-bind(intensityNum) * 15%), transparent)
      calc(v-bind(radiusPct) * 1.8),
